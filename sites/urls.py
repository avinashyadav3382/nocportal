...
from .views import mct_satcom_data_view, add_mct_satcom_entry, mct_satcom_india_map
urlpatterns = [
    path("", india_map_view, name="india-map"),
    path("api/sites/map/", SiteMapAPIView.as_view(), name="site-map-api"),
    path("api/contact-info/<str:sitename>/", contact_info_view, name="contact-info"),
